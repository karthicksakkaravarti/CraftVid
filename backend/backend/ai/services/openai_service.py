...
class OpenAIService:
    ...
    def refine_script(
        self, original_script: str, feedback: str, user: Optional[User] = None
...
"""
        ...
        try:
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are an expert video scriptwriter who refines scripts based on feedback.",
                    },
                    {"role": "user", "content": prompt},
                ],
                max_tokens=1500,
    ...
    def generate_scene_descriptions(
        self, script: str, user: Optional[User] = None
        ...
        try:
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are an expert storyboard artist who converts scripts into detailed scene descriptions. Always respond with valid JSON.",
                    },
                    {"role": "user", "content": prompt},
                ],
                max_tokens=2000,
                ...
                scene_descriptions = [
                    {
                        ...
                        "raw_text": scene_descriptions_text,
                    }
                ]
