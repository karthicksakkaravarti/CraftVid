...
PROJECT_DIR = Path(__file__).resolve(strict=True).parent.parent.parent.parent
# backend/
...
MIDDLEWARE = [
    ...
    "backend.utils.middleware.StandardizedResponseMiddleware",
]
...
ADMINS = [("""karthicksakkaravarthi@gmail.com""", "karthicksakkaravarthi@gmail.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "CraftVid API",
    "DESCRIPTION": "API documentation for CraftVid",
    "VERSION": "1.0.0",
...
# INSTALLED_APPS += ["allauth.socialaccount.providers.google"]  # noqa: F405
...
# Instagram
INSTAGRAM_USERNAME = env("INSTAGRAM_USERNAME", default="")
INSTAGRAM_PASSWORD = env("INSTAGRAM_PASSWORD", default="")
...
SUBSCRIPTION_PLANS = {
    ...
    "premium": {
        ...
        "features": {
            ...
            "max_video_duration": 1800,  # seconds
            "max_resolution": "4K",
            "social_publishing": True,
        },
    },
